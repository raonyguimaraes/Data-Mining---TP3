...
print "Threshold:"+str(DISTANCE_THRESHOLD)

# Define a scoring functionListing 4.2 shows the content of the class SortedArrayClustering. In principle, this is
similar to the SQL statement approach, because all we do is sort the data and print it
on the screen. But we’ve transferred the
def score(tag1, tag2):
...
data_file = open('tags_10000.txt', 'rb')
